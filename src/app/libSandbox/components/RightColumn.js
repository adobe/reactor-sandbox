...
export default ({ templateLocation, isLatestTemplate }) => (
  <div className="description-container">
    ...
    {templateLocation === 'sandbox' ? (
      <>
        <p>
          ...
          IFRAME element. The template represents a simple page that loads an empty Launch library.
        </p>
        <p>
          ...
          You can then edit the file created at the following location: `.sandbox/libSandbox.html`.
          Next time when you refresh the sandbox page iniside the browser, the new content will be
          shown inside the IFRAME.
        </p>
        <p>
        ...
        <Link to={NAMED_ROUTES.LIB_SANDBOX_RULES_EDITOR}>
          <Button variant="cta">
            <Draw />
    ...
    {isLatestTemplate === false ? (
      <p>
        It seems there is a problem with your template. Follow the steps listed in the left pane of
        the page in order to contiune.
      </p>
    ) : null}
    ...
    {templateLocation === 'extension' && isLatestTemplate ? (
      <>
        <p>
          You can customize the template that is loaded in the left pane of the page by editing the
          file found at the following location: `.sandbox/libSandbox.html`.
        </p>

        <p>
          You can edit the information about saved rules, data elements, and extension configuration
          by using the Library Editor.
        </p>
